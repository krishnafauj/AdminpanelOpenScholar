...
import { RoleBadge } from '@/components/Tenant/RoleBadge'

// Tenant Control Plane Components
    ...
    recentRuns: [
      {
        ...
        status: 'success',
        records: 5400,
        timestamp: '2025-02-01 14:02',
      },
      {
        source: 'Crossref',
        status: 'success',
        records: 1200,
        timestamp: '2025-02-01 13:47',
      },
      {
        source: 'Scopus',
        status: 'failed',
        records: 0,
        timestamp: '2025-01-31 18:22',
      },
    ],
  },
}
...
export default function TenantDetailPage() {
  ...
  const renderPipelineCell = useCallback(
  ...
  return (
    <main className="flex-1 p-6 bg-dashboard overflow-y-auto h-full">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <TenantTabs
          tabs={[
            ...
            },
            {
              label: 'Sources',
              content: (
                <SourcesTable sources={tenant.sources} />
              ),
            },
            {
              label: 'Admins',
        ...
        <TenantActions
          onLock={() =>
            alert(`Tenant ${tenant.name} locked`)
          }
          onDisablePipelines={() =>
            alert(`Pipelines disabled for ${tenant.name}`)
          }
          onRotateKeys={() =>
            alert(`API keys rotated for ${tenant.name}`)
          }
          onDelete={() =>
            confirm(
              `Are you sure you want to delete ${tenant.name}? This action is irreversible.`
